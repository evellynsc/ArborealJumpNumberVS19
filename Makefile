...
FLOW_MODEL_OBJ: $(FLOW_MODEL_SRC) $(FLOW_MODEL_H)
	$(CC) $(CFLAGS) $(CFLAGS2) $(BOOSTINCDIR) -c $(FLOW_MODEL_SRC) -o $(FLOW_MODEL_OBJ)
...
CHAR_SOLVER_OBJ:  $(CHAR_SOLVER_SRC) $(CHAR_SOLVER_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(CHAR_SOLVER_SRC) -o $(CHAR_SOLVER_OBJ)

KERNEL_SOLVER_OBJ:  $(KERNEL_SOLVER_SRC) $(KERNEL_SOLVER_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(KERNEL_SOLVER_SRC) -o $(KERNEL_SOLVER_OBJ)
