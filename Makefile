...
ADD_MIN_CUTS_H	=$(PROG_DIR)/solver/callbacks/add_min_cuts.h
ADD_MIN_CUTS_OBJ	=$(PROG_BIN)/add_min_cuts.o
...
ADD_MIN_CUTS_OBJ: $(ADD_MIN_CUTS_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(ADD_MIN_CUTS_H) -o $(ADD_MIN_CUTS_OBJ)
...
ajns: ELEMENTARY_OBJ GRAPH_OBJ INSTANCE_OBJ SOLUTION_OBJ HEURISTIC_OBJ INSTANCE_GENERATOR_OBJ READER_OBJ PROBLEM_DATA_OBJ FLOW_OBJ MODEL_OBJ EXPONENTIAL_MODEL_OBJ FLOW_MODEL_OBJ SOLVER_OBJ MF_SOLVER_OBJ BC_SOLVER_OBJ SOLVER_PARAMS_OBJ PI_INEQUALITY_OBJ PI_SIGMA_INEQUALITY_OBJ PREC_INEQUALITY_OBJ REACHES_INEQUALITY_OBJ SIGMA_INEQUALITY_OBJ UTILS_CALLBACKS_OBJ UTILS_PREPROCESSING_OBJ 
