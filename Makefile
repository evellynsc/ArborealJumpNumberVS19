...
DDL_SOLVER_H	=$(PROG_DIR)/solver/DDLSolver.h
...
CHAR_MODEL_H	=$(PROG_DIR)/solver/CharacterizationBasedFormulation.h
CHAR_MODEL_OBJ	=$(PROG_BIN)/CharacterizationBasedFormulation.o

CHAR_SOLVER_SRC	=$(PROG_DIR)/solver/CharacterizationBasedSolver.cpp
CHAR_SOLVER_H	=$(PROG_DIR)/solver/CharacterizationBasedSolver.h
...
CHAR_MODEL_OBJ: $(CHAR_MODEL_SRC) $(CHAR_MODEL_H)
	$(CC) $(CFLAGS2) -c $(CHAR_MODEL_SRC) -o $(CHAR_MODEL_OBJ)

KERNEL_SOLVER_OBJ: $(KERNEL_SOLVER_SRC) $(KERNEL_SOLVER_H)
	$(CC) $(CFLAGS2) -c $(KERNEL_SOLVER_SRC) -o $(KERNEL_SOLVER_OBJ)

BC_SOLVER_OBJ: $(BC_SOLVER_SRC) $(BC_SOLVER_H)
	$(CC) $(CFLAGS2) -c $(BC_SOLVER_SRC) -o $(BC_SOLVER_OBJ)

DDL_SOLVER_OBJ: $(DDL_SOLVER_SRC) $(DDL_SOLVER_H)
	$(CC) $(CFLAGS2) -c $(DDL_SOLVER_SRC) -o $(DDL_SOLVER_OBJ)

DDL_MODEL_OBJ: $(DDL_MODEL_SRC) $(DDL_MODEL_H)
	$(CC) $(CFLAGS2) -c $(DDL_MODEL_SRC) -o $(DDL_MODEL_OBJ)
