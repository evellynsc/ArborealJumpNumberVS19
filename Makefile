...
BOOSTLIBDIR = /home/lapo/evellyn/boost_1_82_0
...
GENERALINCDIR   = -IArborealJumpNumber
...
PROBLEM_DATA_OBJ: $(PROBLEM_DATA_H)
	$(CC) $(CFLAGS) -c $(PROBLEM_DATA_H) -o $(PROBLEM_DATA_OBJ)

FLOW_OBJ: $(FLOW_SRC) $(FLOW_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(FLOW_SRC) -o $(FLOW_OBJ)

MODEL_OBJ: $(MODEL_SRC) $(MODEL_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(MODEL_SRC) -o $(MODEL_OBJ)
...
DDL_MODEL_OBJ: $(DDL_MODEL_SRC) $(DDL_MODEL_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(DDL_MODEL_SRC) -o $(DDL_MODEL_OBJ)

SOLVER_OBJ: $(SOLVER_SRC) $(SOLVER_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(SOLVER_SRC) -o $(SOLVER_OBJ)

MF_SOLVER_OBJ: $(MF_SOLVER_SRC) $(MF_SOLVER_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(MF_SOLVER_SRC) -o $(MF_SOLVER_OBJ)

DDL_SOLVER_OBJ: $(DDL_SOLVER_SRC) $(DDL_SOLVER_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(DDL_SOLVER_SRC) -o $(DDL_SOLVER_OBJ)

BC_SOLVER_OBJ: $(BC_SOLVER_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(BC_SOLVER_SRC) -o $(BC_SOLVER_OBJ)

SOLVER_PARAMS_OBJ: $(SOLVER_PARAMS_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(SOLVER_PARAMS_H) -o $(SOLVER_PARAMS_OBJ)

PI_INEQUALITY_OBJ: $(PI_INEQUALITY_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(PI_INEQUALITY_H) -o $(PI_INEQUALITY_OBJ)

PI_SIGMA_INEQUALITY_OBJ: $(PI_SIGMA_INEQUALITY_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(PI_SIGMA_INEQUALITY_H) -o $(PI_SIGMA_INEQUALITY_OBJ)

PREC_INEQUALITY_OBJ: $(PREC_INEQUALITY_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(PREC_INEQUALITY_H) -o $(PREC_INEQUALITY_OBJ)

REACHES_INEQUALITY_OBJ: $(REACHES_INEQUALITY_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(REACHES_INEQUALITY_H) -o $(REACHES_INEQUALITY_OBJ)

ADD_MIN_CUTS_LC_OBJ: $(ADD_MIN_CUTS_LC_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(ADD_MIN_CUTS_LC_H) -o $(ADD_MIN_CUTS_LC_OBJ)

ADD_MIN_CUTS_UC_OBJ: $(ADD_MIN_CUTS_UC_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(ADD_MIN_CUTS_UC_H) -o $(ADD_MIN_CUTS_UC_OBJ)

SIGMA_INEQUALITY_OBJ: $(SIGMA_INEQUALITY_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(SIGMA_INEQUALITY_H) -o $(SIGMA_INEQUALITY_OBJ)



UTILS_CALLBACKS_OBJ: $(UTILS_CALLBACKS_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(UTILS_CALLBACKS_H) -o $(UTILS_CALLBACKS_OBJ)

UTILS_PREPROCESSING_OBJ: $(UTILS_PREPROCESSING_H)
	$(CC) $(CFLAGS) $(CFLAGS2) -c $(UTILS_PREPROCESSING_H) -o $(UTILS_PREPROCESSING_OBJ)

ajns: ELEMENTARY_OBJ GRAPH_OBJ INSTANCE_OBJ SOLUTION_OBJ HEURISTIC_OBJ INSTANCE_GENERATOR_OBJ READER_OBJ PROBLEM_DATA_OBJ FLOW_OBJ MODEL_OBJ EXPONENTIAL_MODEL_OBJ FLOW_MODEL_OBJ DDL_MODEL_OBJ SOLVER_OBJ DDL_SOLVER_OBJ MF_SOLVER_OBJ BC_SOLVER_OBJ SOLVER_PARAMS_OBJ PI_INEQUALITY_OBJ PI_SIGMA_INEQUALITY_OBJ ADD_MIN_CUTS_LC_OBJ ADD_MIN_CUTS_UC_OBJ PREC_INEQUALITY_OBJ REACHES_INEQUALITY_OBJ SIGMA_INEQUALITY_OBJ UTILS_CALLBACKS_OBJ UTILS_PREPROCESSING_OBJ 
	$(CC) $(CFLAGS) $(CFLAGS2) $(ELEMENTARY_SRC) $(GRAPH_H) $(INSTANCE_H) $(SOLUTION_SRC) $(HEURISTIC_SRC) $(INSTANCE_GENERATOR_SRC) $(READER_SRC) $(PROBLEM_DATA_H) $(FLOW_SRC) $(MODEL_SRC) $(EXPONENTIAL_MODEL_SRC) $(FLOW_MODEL_SRC) $(DDL_MODEL_SRC) $(SOLVER_SRC) $(MF_SOLVER_SRC) $(BC_SOLVER_SRC) $(DDL_SOLVER_SRC) $(SOLVER_PARAMS_H) $(PI_INEQUALITY_H) $(PI_SIGMA_INEQUALITY_H) $(PREC_INEQUALITY_H) $(REACHES_INEQUALITY_H) $(ADD_MIN_CUTS_UC_H) $(ADD_MIN_CUTS_LC_H) $(SIGMA_INEQUALITY_H) $(UTILS_CALLBACKS_H) $(UTILS_PREPROCESSING_H) $(MAIN_SRC) -o ajns $(CLNFLAGS)
